...
class Exercice
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity=Skill::class, mappedBy="exercice")
     */
    private $skills;

    /**
     * @ORM\OneToMany(targetEntity=Picture::class, mappedBy="exercice")
     */
    private $pictures;
